...
$privacyGuides = [
    'general' => [
        ...
        'intro' => 'Trabaje sobre la copropiedad que esta configurando y use informacion institucional verificada. El orden importa porque varios documentos dependen de versiones publicadas previamente.',
        'before' => [
        ...
        'steps' => [
            ...
            ['Validar el portal antes de socializar', 'Abra el portal desde Resumen y confirme identidad visual, documentos vigentes, unidades habitacionales, canales y textos. No registre decisiones en nombre de un Titular.'],
        ...
        'warning' => 'Verifique toda la informacion antes de aprobar o publicar. Firmar o cerrar expedientes produce evidencia trazable y debe responder a una actuacion real.',
    ],
    'resumen' => [
        'eyebrow' => 'Paso 1',
        ...
        'warning' => 'Marque exclusivamente condiciones que existan en la operacion real: cada seleccion cambia el contenido documental y las validaciones de aprobacion.',
    ],
    'inventario' => [
        'eyebrow' => 'Paso 2',
    ...
    'seguridad' => [
        ...
        'intro' => 'Esta seccion convierte el manual de seguridad en actividades verificables y documenta las responsabilidades individuales de los usuarios.',
        'before' => [
        ...
        'steps' => [
            ...
            ['Obtener la firma individual', 'El firmante recibe un enlace, verifica su correo y firma la instancia. Este proceso documenta su alcance y no bloquea el ingreso al aplicativo.'],
            ...
            ['Cerrar compromisos al cambiar el vinculo', 'Cierre la instancia con motivo y evidencia de devolucion o eliminacion. La activacion del usuario se administra por separado desde Usuarios.'],
        ],
        'done' => [
            'Cada responsabilidad tiene persona o area y acto de designacion.',
            'Los controles criticos tienen evidencia vigente.',
            'Los compromisos individuales reflejan responsabilidades y alcances reales.',
...
?>
<style>
    .pane-guide-bar{display:flex;justify-content:flex-end;margin:0 0 12px}.privacy-guide-trigger{display:inline-flex;align-items:center;justify-content:center;min-height:38px;border:1px solid #cfd6df;background:#fff;color:#172235;border-radius:8px;padding:8px 12px;font-weight:700;cursor:pointer}.privacy-guide-trigger:hover{border-color:#9aa7b8;background:#f7f8fa}.privacy-guide-trigger:focus-visible,.guide-close:focus-visible,.guide-nav button:focus-visible{outline:3px solid #d5a928;outline-offset:2px}.privacy-guide-modal[hidden]{display:none}.privacy-guide-modal{position:fixed;inset:0;z-index:1000;background:rgba(10,18,31,.66);display:grid;place-items:center;padding:20px}.guide-shell{width:min(1120px,100%);height:calc(100dvh - 40px);max-height:760px;background:#fff;border-radius:8px;box-shadow:0 24px 70px rgba(0,0,0,.3);display:grid;grid-template-columns:250px minmax(0,1fr);overflow:hidden}.guide-sidebar{min-height:0;background:#111c2c;color:#fff;padding:24px 18px;overflow-y:auto;overscroll-behavior:contain}.guide-sidebar h2{font-size:1rem;margin:0 0 18px}.guide-nav{display:grid;gap:4px}.guide-nav button{width:100%;border:0;background:transparent;color:#cbd3df;text-align:left;padding:10px;border-radius:6px;font-weight:700;cursor:pointer}.guide-nav button.active{background:#29384c;color:#fff;box-shadow:inset 3px 0 #d5a928}.guide-main{min-width:0;min-height:0;overflow:hidden;display:flex;flex-direction:column}.guide-head{flex:0 0 auto;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #e3e7ed;padding:14px 20px}.guide-head strong{font-size:.9rem}.guide-close{width:40px;height:40px;border:0;background:#eef1f5;color:#172235;border-radius:50%;font-size:1.5rem;line-height:1;cursor:pointer}.guide-content{flex:1 1 auto;min-height:0;padding:28px 34px 40px;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable;touch-action:pan-y}.guide-panel[hidden]{display:none}.guide-eyebrow{font-size:.72rem;text-transform:uppercase;color:#7b5b00;font-weight:800}.guide-panel h2{font-size:1.65rem;line-height:1.2;margin:7px 0 10px;letter-spacing:0}.guide-intro{color:#526071;line-height:1.6;margin:0 0 24px}.guide-panel h3{font-size:.92rem;margin:24px 0 10px;letter-spacing:0}.guide-before,.guide-done{margin:0;padding-left:20px;color:#334155;line-height:1.55}.guide-before li,.guide-done li{margin:6px 0}.guide-steps{list-style:none;margin:0;padding:0;counter-reset:guide-step}.guide-steps li{counter-increment:guide-step;display:grid;grid-template-columns:38px minmax(0,1fr);gap:12px;padding:15px 0;border-bottom:1px solid #e5e7eb}.guide-steps li::before{content:counter(guide-step);display:grid;place-items:center;width:32px;height:32px;border-radius:50%;background:#172235;color:#fff;font-weight:800}.guide-step-copy strong{display:block;margin:1px 0 5px}.guide-step-copy span{display:block;color:#526071;line-height:1.55}.guide-warning{margin-top:24px;border-left:4px solid #d5a928;background:#fff8df;padding:14px 16px;color:#4d3c09;line-height:1.5}.guide-progress{font-size:.78rem;color:#667085}.guide-progress b{color:#172235}@media(max-width:760px){.privacy-guide-modal{padding:0}.guide-shell{height:100dvh;max-height:none;width:100%;border-radius:0;grid-template-columns:1fr;grid-template-rows:auto minmax(0,1fr)}.guide-sidebar{padding:12px 14px;overflow-x:auto;overflow-y:hidden}.guide-sidebar h2{margin-bottom:10px}.guide-nav{display:flex;overflow-x:auto}.guide-nav button{width:auto;white-space:nowrap}.guide-content{padding:22px 20px 36px}.guide-panel h2{font-size:1.35rem}.guide-head{padding:10px 14px}}
</style>
