...
class CreateCensoArrendatarios extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->createTable('censo_arrendatarios', true, ['ENGINE' => 'InnoDB']);
    }

    public function down()
    {
        $this->forge->dropTable('censo_arrendatarios', true);
    }
}
